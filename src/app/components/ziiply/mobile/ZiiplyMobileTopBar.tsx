...
// V715_INTERNAL_TOPBAR_DEBUG_VISIBLE
// Pohjana V714.
// Korjaus/debug:
// - page ei käytä erillistä ZiiplyMobileTopBar-komponenttia
// - käytössä on page.tsx:n sisäinen KauppiasMobileTopBar
// - lisätty näkyvä TOPBAR INTERNAL V715 -debug-merkki sisäiseen topbariin
// - muutettu SÄHKÖ -> SÄHKÖ V715 näkyväksi tarkistusta varten
// - ei muita logiikkamuutoksia.
...
function KauppiasMobileTopBar({
  ...
  return (
    <div className="fixed inset-x-0 top-[max(env(safe-area-inset-top),0px)] z-[90] mx-auto block w-full translate-y-0 transform-gpu px-[6px] pt-[4px] sm:hidden">
      <div className="pointer-events-none absolute left-[18px] top-[0px] z-[999] rounded-full bg-fuchsia-600 px-3 py-0.5 text-[11px] font-black text-white shadow-[0_2px_6px_rgba(0,0,0,0.35)]">
        TOPBAR INTERNAL V715
      </div>
