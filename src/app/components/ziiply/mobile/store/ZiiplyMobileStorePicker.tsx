  ...
  function renderStorePickerMenu(
    ...
    const menuBody = (
      <>
        ...
        <div
          className={`${compact ? "max-h-[24dvh]" : "max-h-48"} overflow-y-auto overscroll-contain pr-1 [-webkit-overflow-scrolling:touch] touch-pan-y`}
        >
          {options.length === 0 ? (
    ...
    return (
      <div className="col-span-2 mt-1 w-full rounded-[1.35rem] bg-white p-3 text-left text-xs shadow-[0_12px_32px_rgba(15,23,42,0.14)] ring-1 ring-slate-200">
        {menuBody}
      </div>
    );
  }
