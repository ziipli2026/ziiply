...
function AssistantBadge({
  ...
  return (
    <div className="flex h-[88px] w-[88px] shrink-0 items-center justify-center overflow-hidden rounded-[1.1rem] bg-[#f7e9c3] shadow-[inset_0_0_0_2px_rgba(255,255,255,0.55)]">
      <img
        src={src}
        alt={alt}
        draggable={false}
...
export default function ZiiplyStoreLocaCard({
  ...
  return (
    <section
      className={cx(
        "ziiply-store-loca-card relative h-[112px] overflow-hidden rounded-[2.1rem] border-[3px] border-[#b99d62] bg-gradient-to-b from-[#f7e9c3] via-[#f0d9a4] to-[#dfbf7e] px-5 py-2 shadow-[0_0_0_2px_#fff3cf_inset,0_7px_0_rgba(80,58,25,0.28),0_18px_28px_rgba(45,31,12,0.12)] ring-1 ring-[#fff7df]/80",
        className,
      )}
    >
      ...
      <div className="relative z-10 grid h-full grid-cols-[minmax(450px,1fr)_310px_224px] items-center gap-7">
        <div className="grid h-full min-w-0 grid-rows-[24px_1fr] items-center">
          <p
            className="self-end pb-1 text-[14px] font-black uppercase tracking-[0.42em] text-[#746742] drop-shadow-[0_1px_0_#fff7df]"
            style={{ fontFamily: copperplateFont }}
          >
            Sijainti
          </p>

          <div className="flex h-[64px] items-center gap-5 self-center">
            <button
              type="button"
              ...
              className={cx(
                "flex h-[56px] w-[72px] shrink-0 items-center justify-center rounded-[1.35rem] border-2 text-2xl font-black shadow-[0_4px_0_rgba(91,72,44,0.16),inset_0_0_0_2px_rgba(255,255,255,0.65)] ring-1 transition active:scale-[0.98]",
                usingOwnLocation
            ...
            <input
              ...
              className="h-[56px] min-w-0 flex-1 rounded-[1.45rem] border-2 border-[#c6a86d] bg-[#fff9ea] px-5 text-[22px] font-black leading-none text-[#27412a] shadow-[inset_0_2px_8px_rgba(91,65,28,0.10),0_1px_0_#fff6dc] outline-none placeholder:text-[#8b846f] focus:border-[#0b7f3a] focus:ring-4 focus:ring-[#c4dfbd]"
            />
          </div>
        </div>
        ...
        <div className="grid h-full min-w-0 grid-rows-[24px_1fr] items-center">
          <p
            className="self-end pb-1 text-center text-[14px] font-black uppercase tracking-[0.42em] text-[#746742] drop-shadow-[0_1px_0_#fff7df]"
            style={{ fontFamily: copperplateFont }}
          >
            Kaupat
          </p>
        ...
        <div className="flex h-[88px] items-center justify-end gap-3 overflow-hidden">
