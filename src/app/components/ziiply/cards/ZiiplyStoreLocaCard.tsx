...
export default function ZiiplyStoreLocaCard({
  ...
  return (
    <section
      className={cx(
        "ziiply-store-loca-card relative overflow-visible rounded-[2.1rem] border-[3px] border-[#b99d62] bg-gradient-to-b from-[#f7e9c3] via-[#f0d9a4] to-[#dfbf7e] px-4 py-3 shadow-[0_0_0_2px_#fff3cf_inset,0_7px_0_rgba(80,58,25,0.28),0_18px_28px_rgba(45,31,12,0.12)] ring-1 ring-[#fff7df]/80",
        className,
      )}
    >
      ...
      <div className="relative z-10 grid grid-cols-[130px_minmax(250px,1fr)_300px] items-center gap-5">
        <div className="flex h-[104px] flex-col justify-center">
          <p
            className="mb-2 text-center text-[13px] font-black uppercase tracking-[0.34em] text-[#746742] drop-shadow-[0_1px_0_#fff7df]"
          ...
          <button
            ...
            className={cx(
              "mx-auto flex h-[60px] w-[92px] shrink-0 items-center justify-center rounded-[1.35rem] border-2 text-2xl font-black shadow-[0_3px_0_rgba(91,72,44,0.16),inset_0_0_0_1px_rgba(255,255,255,0.65)] ring-1 transition active:scale-[0.98]",
              usingOwnLocation
        ...
        <div className="flex h-[104px] items-center">
          <input
            ...
            className="h-[60px] w-full rounded-[1.45rem] border-2 border-[#c6a86d] bg-[#fff9ea] px-7 text-[18px] font-black leading-none text-[#27412a] shadow-[inset_0_2px_8px_rgba(91,65,28,0.10),0_1px_0_#fff6dc] outline-none placeholder:text-[#8b846f] focus:border-[#0b7f3a] focus:ring-4 focus:ring-[#c4dfbd]"
          />
        </div>
        ...
        <div className="flex h-[104px] flex-col justify-center">
          ...
          <button
            ...
            className="mx-auto flex h-[70px] w-full items-center justify-center overflow-hidden rounded-[1.55rem] border-[3px] border-[#17452f] bg-gradient-to-b from-[#f8edc8] via-[#e2bf72] to-[#b98233] px-4 text-[#143b24] shadow-[0_6px_0_rgba(50,36,16,0.34),0_12px_18px_rgba(70,44,14,0.12),inset_0_0_0_2px_rgba(255,255,255,0.36)] transition hover:brightness-105 active:translate-y-[1px] active:shadow-[0_3px_0_rgba(50,36,16,0.34),inset_0_0_0_2px_rgba(255,255,255,0.36)]"
            style={{ fontFamily: cooperFont }}
            aria-label="Avaa kauppavalikot"
            title="Avaa kauppavalikot"
          >
            <span className="flex h-[54px] w-[172px] shrink-0 items-center justify-center overflow-hidden rounded-[1.1rem] border-2 border-[#194b31] bg-[#f5e1a7] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.36)]">
              <img
