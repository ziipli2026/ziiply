  ...
  return (
    ...
    >
      <section className="ziiply-cart-paper-pop relative flex h-[calc(100dvh-env(safe-area-inset-top)-env(safe-area-inset-bottom)-6.9rem)] max-h-[46rem] min-h-[31rem] w-full max-w-[28rem] flex-col overflow-hidden rounded-[2.1rem] border-[5px] border-[#3b2414] bg-[linear-gradient(135deg,#2a170e_0%,#5a3720_45%,#2a170e_100%)] shadow-[0_12px_0_rgba(35,23,13,0.28),0_24px_52px_rgba(0,0,0,0.30)]">
        ...
        <div className="relative z-10 grid shrink-0 grid-cols-[2.15rem_minmax(0,1fr)_3.55rem_4.25rem] px-6 pt-[2.28rem] text-[0.54rem] font-black uppercase tracking-[0.18em] text-transparent opacity-0" style={{ fontFamily: copperplateFont }}>
          <span>N:o</span>
          <span>Nimike</span>
        ...
        <div className="relative z-10 min-h-0 flex-1 overflow-y-auto px-5 pb-[6.2rem] pt-[0.78rem] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {!hasItems ? (
