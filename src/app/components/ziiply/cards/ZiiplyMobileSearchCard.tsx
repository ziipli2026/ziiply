  ...
  return (
    <button
      ...
      className={cx(
        ...
        disabled && isGosta
          ? "cursor-not-allowed grayscale opacity-55 brightness-[0.62] contrast-75 saturate-0 shadow-none ring-0"
          : disabled
            ? "cursor-not-allowed"
            : "hover:brightness-105 hover:saturate-[1.08]",
    ...
    >
      <img
        ...
        className={cx(
          ...
          kind === "voice" ? "h-[92%] w-[92%]" : "h-[92%] w-[92%]",
        )}
        draggable={false}
      />
    </button>
