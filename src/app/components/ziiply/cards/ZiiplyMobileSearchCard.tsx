...
// UUSI_ZIIPLY_MOBILE_SEARCH_CARD_V630_FINAL_MOCKUP_BALANCED_LIFT
...
export default function ZiiplyMobileSearchCard({
  ...
  return (
    <div
      data-ziiply-mobile-search-card-version="UUSI_V630_FINAL_MOCKUP_BALANCED_LIFT"
    ...
    >
      <section className="relative isolate flex h-full w-full max-w-[28rem] flex-col overflow-hidden rounded-[1.8rem] border-[2px] border-[#ead9a8] bg-[#f6ebc6] px-3 pb-3 pt-3 text-[#20301f] shadow-[inset_0_0_0_2px_rgba(216,189,117,0.34)]">
        ...
        <div className="relative z-10 flex h-full min-h-0 flex-col">
          ...
          <div className="relative z-10 mt-4 flex min-h-[7.6rem] items-end justify-center overflow-hidden rounded-[1.55rem] border-[3px] border-[#d2b170] bg-[#fff1bf] px-4 pb-5 pt-4 text-center text-[clamp(0.88rem,2.85vw,1.08rem)] font-black leading-[1.16] text-[#6f5630] shadow-[inset_0_1px_0_rgba(255,255,255,0.65),0_4px_0_rgba(91,72,44,0.13)]">
            <span className="block w-full whitespace-normal">
              {subtitle || predictiveText}
            </span>
          </div>

          {/* V630: maltillinen koko alapaketin nosto finaali-mockupin mukaan.
              Ei aggressiivista -2rem/-3rem siirtoa: hakukenttä jää näkyviin iOS-näppiksen yläpuolelle,
              mutta kokonaisuus ei karkaa liian ylös eikä infolaatikko mene nappien päälle. */}
          <div className="relative z-10 -translate-y-[0.85rem]">
            <div className="mt-[0.45rem] grid grid-cols-[1.18fr_0.72fr_1.18fr] items-center gap-3">
            <AssistantButton
              kind="gosta"
