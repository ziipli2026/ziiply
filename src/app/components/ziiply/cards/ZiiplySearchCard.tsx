...
function AssistantButton({
  ...
  return (
    <button
      ...
      title={title}
      className={cx(
        "grid h-[78px] min-w-0 w-full grid-cols-[72px_minmax(0,1fr)] items-center gap-2 overflow-hidden rounded-[24px] border-[3px] px-2 text-left shadow-[0_5px_0_rgba(91,72,44,0.20),inset_0_0_0_2px_rgba(255,255,255,0.48)] transition active:translate-y-[1px]",
        isGosta
    ...
    >
      <span
        className={cx(
          "grid h-[72px] w-[72px] shrink-0 place-items-center overflow-hidden rounded-[20px] border-[2px] bg-[#f7edc6]",
      ...
      <span className="min-w-0 flex-1 overflow-hidden">
        <span
          className="block truncate whitespace-nowrap text-[22px] font-black italic leading-[0.95]"
        ...
        >
          <span className="block truncate whitespace-nowrap">{subline[0]}</span>
          <span className="block truncate whitespace-nowrap">{subline[1]}</span>
        </span>
      </span>
    </button>
  );
...
export default function ZiiplySearchCard({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 grid h-[66px] grid-cols-[minmax(0,1fr)_minmax(230px,310px)] items-start gap-4">
        <div className="min-w-0 overflow-hidden">
          ...
          <h1
            className="mt-1 max-w-full truncate whitespace-nowrap text-[clamp(29px,2.65vw,40px)] font-black italic leading-[0.95] text-[#203b25]"
            style={{ fontFamily: cooperFont }}
          >
        ...
        <button
          ...
          className="h-[50px] justify-self-end rounded-[24px] border-[4px] border-[#0b6330] bg-gradient-to-b from-[#139143] to-[#087237] px-6 text-[20px] font-black italic leading-none text-[#fff0d5] shadow-[0_0_0_3px_rgba(255,255,255,0.18)_inset,0_5px_0_#064a26] transition hover:brightness-105 active:translate-y-1 active:shadow-[0_2px_0_#064a26]"
          style={{ fontFamily: cooperFont }}
        >
          Lisää vihkosesta
        </button>
      ...
      {!showTypingView ? (
        <div className="relative z-10 mt-2 grid grid-cols-[minmax(245px,1fr)_minmax(218px,268px)_minmax(245px,1fr)] items-center gap-4 overflow-hidden">
          <AssistantButton
            kind="gosta"
        ...
        <>
          <div className="relative z-10 mt-2 h-[64px] overflow-hidden rounded-[24px] border-[4px] border-[#9d8350] bg-[#fff4d3] p-2 shadow-none">
            <textarea
              ref={inputRef}
              value={value}
              onChange={handleTextChange}
              ...
              className="block h-full w-full resize-none overflow-hidden rounded-[18px] border-0 bg-[#fff9e8] px-7 py-[8px] text-[26px] font-black leading-none text-[#172417] outline-none placeholder:text-[#8b846f]"
              style={{ fontFamily: serifFont }}
            />
          </div>

          <div className="relative z-10 mt-3 grid grid-cols-[minmax(245px,1fr)_minmax(168px,204px)_minmax(245px,1fr)] items-center gap-4 overflow-hidden">
            <AssistantButton
              kind="gosta"
              onClick={onGostaSearch}
              loading={gostaLoading}
      ...
      <div className="absolute bottom-[13px] left-[58px] right-[58px] z-10">
        <button
          type="button"
          onClick={onScan}
