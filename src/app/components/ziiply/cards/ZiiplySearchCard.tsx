...
function GostaButton({
  ...
  return (
    <button
      ...
      className={cx(
        "group flex h-[92px] min-h-[92px] w-full min-w-0 items-center gap-3 overflow-hidden rounded-[24px] border-[3px] border-[#7b935f] bg-gradient-to-b from-[#eff2d2] to-[#cdd99b] px-3 py-3 text-left shadow-[0_5px_0_rgba(91,72,44,0.22),inset_0_0_0_2px_rgba(255,255,255,0.5)] transition active:translate-y-[1px]",
...
function JustiinaButton({
  ...
  return (
    <button
      ...
      aria-disabled={disabled}
      className={cx(
        "group flex h-[92px] min-h-[92px] w-full min-w-0 items-center gap-3 overflow-hidden rounded-[24px] border-[3px] border-[#c69f48] bg-gradient-to-b from-[#fff0bd] to-[#eec965] px-3 py-3 text-left shadow-[0_5px_0_rgba(91,72,44,0.22),inset_0_0_0_2px_rgba(255,255,255,0.5)] transition active:translate-y-[1px]",
        disabled ? "cursor-not-allowed opacity-55" : "hover:brightness-105",
      )}
