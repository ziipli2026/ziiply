...
export default function ZiiplySearchCard({
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute right-[18px] top-[148px] z-[55] h-[174px] w-[92px] bg-[#f6ebc6] opacity-100 [background-image:radial-gradient(#d8bd75_1.2px,transparent_1.2px)] [background-size:18px_18px]" />
