...
export default function ZiiplySearchCard({
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute bottom-[38px] right-[10px] top-[142px] z-[5] w-[82px] bg-[#f6ebc6] opacity-100 [background-image:radial-gradient(#d8bd75_1.2px,transparent_1.2px)] [background-size:18px_18px] [background-position:9px_0]" />
