...
// ZIIPLY_MOBILE_COMPARE_CARDRESPONSIVE_V43_PAPER_SHARE_TAG
                  ...
                  >
                    {onShareStore ? (
                      <button
                        ...
                        className="absolute right-[0.52rem] top-[0.42rem] z-20 grid h-[1.82rem] w-[1.46rem] place-items-center rounded-[0.28rem] border-[1.5px] border-[#8b713d] bg-[linear-gradient(180deg,#f5e5bd_0%,#d6b875_100%)] text-[#51361a] shadow-[0_2px_4px_rgba(45,30,10,0.17),inset_0_0_0_1px_rgba(255,249,220,0.55)] active:translate-y-[1px]"
                        aria-label={`Jaa ${store.name} kori`}
                        title="Jaa kori"
                      >
                        <span className="absolute -top-[0.46rem] left-1/2 h-[0.54rem] w-[1px] -translate-x-1/2 bg-[#6c4b22]" />
                        <span className="absolute top-[0.15rem] h-[0.26rem] w-[0.26rem] rounded-full border border-[#8b713d] bg-[#fff4ce]" />
                        <svg
                          aria-hidden="true"
                          viewBox="0 0 24 18"
                          className="mt-[0.28rem] h-[0.86rem] w-[1.02rem]"
                        >
                          <path
