          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <img
                src="/ziiply.png"
                alt="Ziiply"
                className="h-9 w-auto max-w-[118px] shrink-0 object-contain"
              />
              <div className="min-w-0">
                <p className="truncate text-[11px] font-bold text-slate-500">{activeArea.label} · {storeMode === "local" ? "lähikaupat" : "tavaratalot"}</p>
              </div>
            </div>
          </div>
