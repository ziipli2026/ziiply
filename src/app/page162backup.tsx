...
export default function Page() {
  ...
  useEffect(() => {
    const timeout = window.setTimeout(() => setShowLaunchScreen(false), 650);
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-slate-100 px-2 pb-32 pt-[4.75rem] text-slate-950 sm:px-4 sm:py-4 md:pb-4">
      {showLaunchScreen && (
        <div className="fixed inset-0 z-[90] flex items-center justify-center bg-slate-950 text-white sm:hidden">
          <div className="text-center">
            <div className="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-[1.75rem] bg-green-500 text-4xl font-black shadow-2xl">Z</div>
            <p className="text-2xl font-black tracking-tight">Ziiply</p>
            <p className="mt-1 text-xs font-bold uppercase tracking-[0.25em] text-green-200">MVP</p>
          </div>
        </div>
      )}
        ...
        <div className="mx-auto flex max-w-md items-center justify-between gap-3">
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-2xl bg-green-600 text-lg font-black text-white shadow-sm">Z</div>
              <div className="min-w-0">
                <p className="text-base font-black leading-none tracking-tight text-slate-950">Ziiply</p>
                <p className="mt-0.5 truncate text-[11px] font-bold text-slate-500">{activeArea.label} · {storeMode === "local" ? "lähikaupat" : "tavaratalot"}</p>
              </div>
            </div>
          </div>
